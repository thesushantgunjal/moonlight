    ...
    <section>
      ...
      <div class="container">
        <div class="cs_section_heading cs_style_1 text-center">
          <p class="cs_section_subtitle cs_medium cs_letter_spacing_1 cs_mb_28 cs_mb_lg_15 text-uppercase">Rooms & Accommodation</p>
          <h2 class="cs_fs_67 mb-0">Stay in Comfort, Sleep in Luxury</h2>
        </div>
    ...
    <section class="cs_bg_filed" data-src="<?= base_url() ?>assets/web/assets/img/form_bg_1.jpg">
      <div class="cs_height_135 cs_height_lg_70"></div>
      <div class="container">
        <h2 class="text-center cs_white_color cs_fs_50 mb-0 cs_form_heading_1">Secure Your Spot: Reserve Your <br>Stay at The Moonlight Resort</h2>
        <div class="cs_height_76 cs_height_lg_55"></div>
        <form action="<?=base_url()?>" class="cs_form cs_style_4 cs_type_2 cs_accent_bg cs_radius_5 position-relative cs_zindex_10">
