...
<section class="cs_hero_7_wrap position-relative">
    ...
    <div class="cs_hero_7_form">
        <div class="container">
            <form action="https://html.laralink.com/seapearl/search-result.html" class="cs_form cs_style_4 cs_type_4 position-relative cs_zindex_10">
...
<section class="cs_gray_bg">
    ...
    <div class="container">
        <div class="cs_section_heading cs_style_1 text-center">
            ...
            <h2 class="cs_fs_67 mb-0 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Our Exquisite Rooms & <br>Suites Collection</h2>
        </div>
        ...
        <div class="cs_grid_style_4">
            <div class="cs_grid_item">
                <a href="room-details.html" class="cs_card cs_style_4 cs_type_1 d-block position-relative">
                    <img class="cs_card_thumb w-100 h-100" src="<?= base_url() ?>assets/web/assets/img/room_17.jpg" alt="Room">
                    <span class="cs_card_price cs_accent_color cs_medium cs_fs_15 cs_white_bg position-absolute">$320/Night</span>
            ...
            <div class="cs_grid_item">
                <a href="room-details.html" class="cs_card cs_style_4 cs_type_1 d-block position-relative">
                    <img class="cs_card_thumb w-100 h-100" src="<?= base_url() ?>assets/web/assets/img/room_18.jpg" alt="Room">
                    <span class="cs_card_price cs_accent_color cs_medium cs_fs_15 cs_white_bg position-absolute">$450/Night</span>
                    <div class="cs_card_info position-absolute start-0 top-0 h-100 w-100">
                        <div>
            ...
            <div class="cs_grid_item">
                <a href="room-details.html" class="cs_card cs_style_4 cs_type_1 d-block position-relative">
                    <img class="cs_card_thumb w-100 h-100" src="<?= base_url() ?>assets/web/assets/img/room_19.jpg" alt="Room">
                    <span class="cs_card_price cs_accent_color cs_medium cs_fs_15 cs_white_bg position-absolute">$520/Night</span>
                    <div class="cs_card_info position-absolute start-0 top-0 h-100 w-100">
                        <div>
            ...
            <div class="cs_grid_item">
                <a href="room-details.html" class="cs_card cs_style_4 cs_type_1 d-block position-relative">
                    <img class="cs_card_thumb w-100 h-100" src="<?= base_url() ?>assets/web/assets/img/room_20.jpg" alt="Room">
                    <span class="cs_card_price cs_accent_color cs_medium cs_fs_15 cs_white_bg position-absolute">$620/Night</span>
                    <div class="cs_card_info position-absolute start-0 top-0 h-100 w-100">
                        <div>
            ...
            <div class="cs_grid_item">
                <a href="room-details.html" class="cs_card cs_style_4 cs_type_1 d-block position-relative">
                    <img class="cs_card_thumb w-100 h-100" src="<?= base_url() ?>assets/web/assets/img/room_21.jpg" alt="Room">
                    <span class="cs_card_price cs_accent_color cs_medium cs_fs_15 cs_white_bg position-absolute">$350/Night</span>
                    <div class="cs_card_info position-absolute start-0 top-0 h-100 w-100">
                        <div>
                    ...
                    <div class="cs_slider_wrapper">
                        <div class="cs_slide">
                            <div class="cs_iconbox cs_style_3 cs_radius_5 cs_white_bg">
                                <div class="cs_iconbox_icon cs_mb_29 cs_center cs_radius_5 cs_white_bg"><img src="<?= base_url() ?>assets/web/assets/img/icons/restaurant.svg" alt="Icon"></div>
                        ...
                        <div class="cs_slide">
                            <div class="cs_iconbox cs_style_3 cs_radius_5 cs_white_bg">
                                <div class="cs_iconbox_icon cs_mb_29 cs_center cs_radius_5 cs_white_bg"><img src="<?= base_url() ?>assets/web/assets/img/icons/massage.svg" alt="Icon"></div>
                        ...
                        <div class="cs_slide">
                            <div class="cs_iconbox cs_style_3 cs_radius_5 cs_white_bg">
                                <div class="cs_iconbox_icon cs_mb_29 cs_center cs_radius_5 cs_white_bg"><img src="<?= base_url() ?>assets/web/assets/img/icons/gym.svg" alt="Icon"></div>
                        ...
                        <div class="cs_slide">
                            <div class="cs_iconbox cs_style_3 cs_radius_5 cs_white_bg">
                                <div class="cs_iconbox_icon cs_mb_29 cs_center cs_radius_5 cs_white_bg"><img src="<?= base_url() ?>assets/web/assets/img/icons/swimmer.svg" alt="Icon"></div>
                        ...
                        <div class="cs_slide">
                            <div class="cs_iconbox cs_style_3 cs_radius_5 cs_white_bg">
                                <div class="cs_iconbox_icon cs_mb_29 cs_center cs_radius_5 cs_white_bg"><img src="<?= base_url() ?>assets/web/assets/img/icons/briefcase.svg" alt="Icon"></div>
                        ...
                        <div class="cs_slide">
                            <div class="cs_iconbox cs_style_3 cs_radius_5 cs_white_bg">
                                <div class="cs_iconbox_icon cs_mb_29 cs_center cs_radius_5 cs_white_bg"><img src="<?= base_url() ?>assets/web/assets/img/icons/room-service.svg" alt="Icon"></div>
...
<section class="cs_primary_bg">
    ...
    <div class="container">
        <div class="cs_section_heading cs_style_1 text-center">
            ...
            <h2 class="cs_fs_67 mb-0 cs_white_color wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Explore Unforgettable Experiences</h2>
        </div>
        <div class="cs_height_80 cs_height_lg_50"></div>
    </div>
    <div class="cs_slider cs_style_1 cs_lightgallery">
        <div class="container">
            <div class="cs_slider_container" data-fade-slide="1" data-autoplay="0" data-loop="1" data-speed="900" data-center="0" data-variable-width="0" data-slides-per-view="1">
                <div class="cs_slider_wrapper">
                    <div class="cs_slide">
                        <a href="<?= base_url() ?>assets/web/assets/img/gallery_6.jpg" class="cs_gallery_item cs_style_2 cs_lightbox_item overflow-hidden cs_radius_5 d-block cs_custom_pointer_wrap">
                            <img src="<?= base_url() ?>assets/web/assets/img/gallery_6.jpg" alt="Gallery">
                            <span class="cs_mouse_point cs_style_1">View Large</span>
                        </a>
                    </div>
                    <div class="cs_slide">
                        <a href="<?= base_url() ?>assets/web/assets/img/gallery_7.jpg" class="cs_gallery_item cs_style_2 cs_lightbox_item overflow-hidden cs_radius_5 d-block cs_custom_pointer_wrap">
                            <img src="<?= base_url() ?>assets/web/assets/img/gallery_7.jpg" alt="Gallery">
                            <span class="cs_mouse_point cs_style_1">View Large</span>
                        </a>
                    </div>
                    <div class="cs_slide">
                        <a href="<?= base_url() ?>assets/web/assets/img/gallery_8.jpg" class="cs_gallery_item cs_style_2 cs_lightbox_item overflow-hidden cs_radius_5 d-block cs_custom_pointer_wrap">
                            <img src="<?= base_url() ?>assets/web/assets/img/gallery_8.jpg" alt="Gallery">
                            <span class="cs_mouse_point cs_style_1">View Large</span>
                        </a>
                    </div>
                    <div class="cs_slide">
                        <a href="<?= base_url() ?>assets/web/assets/img/gallery_5.jpg" class="cs_gallery_item cs_style_2 cs_lightbox_item overflow-hidden cs_radius_5 d-block cs_custom_pointer_wrap">
...
<section>
    ...
    <div class="container">
        <div class="cs_section_heading cs_style_1 text-center">
            <p class="cs_section_subtitle cs_medium cs_letter_spacing_1 cs_mb_28 cs_mb_lg_15 text-uppercase">LUXARIOUS FECILITIES</p>
    ...
    <div class="container">
        <div class="row cs_row_gap_60 cs_gap_y_40">
            <div class="col-lg-4">
                <div class="cs_card cs_style_6 text-center cs_radius_5 overflow-hidden">
                    <a href="room-details.html" class="cs_card_thumb overflow-hidden d-block position-relative">
                        <img src="<?= base_url() ?>assets/web/assets/img/feature_img_18.jpg" alt="Feature" class="w-100">
                    </a>
                    <div class="cs_card_info">
                        ...
                        <a href="room-details.html" class="cs_btn cs_style_2 cs_accent_btn cs_medium cs_radius_5 cs_fs_15">
                            <b>Details View</b>
                            <span>
                                <i>
                                    <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-lg-4">
                <div class="cs_card cs_style_6 text-center cs_radius_5 overflow-hidden">
                    <a href="room-details.html" class="cs_card_thumb overflow-hidden d-block position-relative">
                        <img src="<?= base_url() ?>assets/web/assets/img/feature_img_19.jpg" alt="Feature" class="w-100">
                    </a>
                    <div class="cs_card_info">
                        <h2 class="cs_card_title cs_fs_38 cs_mb_19">
...
<a href="https://www.youtube.com/embed/UJEUwEJ6gH4" class="cs_video_block cs_style_1 cs_type_1 cs_video_open text-center cs_center position-relative">
    <div class="cs_video_block_bg h-100 w-100 position-absolute start-0 top-0 cs_bg_filed cs_primary_bg" data-src="<?= base_url() ?>assets/web/assets/img/video_bg_6.jpg"></div>
    <span class="cs_play_btn_2 cs_center rounded-circle">
        <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<section>
    ...
    <div class="container">
        <div class="cs_section_heading cs_style_1 text-center">
            ...
            <h2 class="cs_fs_67 mb-0 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Explore Our Frequently <br>Asked Questions</h2>
        </div>
                ...
                <div class="cs_accordians cs_style_1">
                    <div class="cs_accordian active">
                        <div class="cs_accordian_head">
                            <h2 class="cs_accordian_title cs_fs_28 mb-0">What are the check-in and check-out times at Seapearl?</h2>
