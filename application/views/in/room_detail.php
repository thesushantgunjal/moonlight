    ...
    <section>
      ...
      <div class="container">
        <div class="cs_plr_70">
          <h2 class="cs_fs_67 mb-0 text-center">Experience a cozy, well-appointed stay at The Moonlight Resort with breakfast, unlimited thermal pool access, and Spa & Wellness facilities. No extra beds.</h2>
        </div>
      </div>
      <div class="cs_height_150 cs_height_lg_80"></div>
      <div class="container">
        <div class="row cs_gap_y_40">
          <div class="col-lg-6">
            <div class="cs_room_details">
              <h3 class="cs_fs_38 cs_mb_29 cs_mb_lg_20">The Moonlight Resort – Cozy Comfort & Luxury</h3>
              <p class="cs_mb_49 cs_mb_lg_30">Relax in our cozy, well-appointed room featuring premium bedding, smart TV, high-speed Wi-Fi, and a minibar. Enjoy a coffee and tea set, air conditioning, and a dedicated workspace. Unwind in the bathroom with a refreshing shower, bathrobe, and slippers for added comfort. Our non-smoking rooms offer a Jain-friendly ambiance with purity assured. Your stay includes 24/7 room service, housekeeping, breakfast, and unlimited access to our thermal pools, Spa & Wellness facilities.</p>
              <h3 class="cs_fs_31 cs_mb_29 cs_mb_lg_20">Facilities</h3>
              <ul class="cs_list cs_style_3 cs_mp_0">
                <li><i class="fa fa-bed"></i> Premium Bedding</li>
                <li><i class="fa fa-tv"></i> Smart TV</li>
                <li><i class="fa fa-wifi"></i> High-Speed Wi-Fi</li>
                <li><i class="fa fa-leaf"></i> Jain-Friendly Ambiance</li>
                <li><i class="fa fa-concierge-bell"></i> 24/7 Service</li>
              </ul>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="cs_pl_110">
              <form action="https://html.laralink.com/seapearl/complete-reservation.html" class="cs_book_now_card cs_accent_bg cs_radius_5">
                <div class="cs_book_now_card_head cs_mb_30">
                  ...
                  <h2 class="cs_book_now_card_price cs_fs_38 cs_white_color mb-0 text-center">&#8377; 320<span class="cs_secondary_font cs_fs_21">/Night</span></h2>
                </div>
          ...
          <div class="overflow-hidden cs_radius_5">
            <div class="cs_gallery_slider_nav slick-slider">
              <div class="cs_gallery_slider_thumb_mini">
                <img src="<?= base_url() ?>assets/web/assets/img/room_sm_1.jpg" alt="Thumb">
              </div>
              <div class="cs_gallery_slider_thumb_mini">
                <img src="<?= base_url() ?>assets/web/assets/img/room_sm_2.jpg" alt="Thumb">
              </div>
              <div class="cs_gallery_slider_thumb_mini">
                <img src="<?= base_url() ?>assets/web/assets/img/room_sm_3.jpg" alt="Thumb">
              </div>
              <div class="cs_gallery_slider_thumb_mini">
                <img src="<?= base_url() ?>assets/web/assets/img/room_sm_1.jpg" alt="Thumb">
              </div>
          ...
          <div class="position-relative overflow-hidden cs_radius_5 cs_gallery_hover_show_nav cs_primary_bg">
            <div class="cs_gallery_slider_thumb slick-slider">
              <div class="cs_gallery_slider_thumb_item">
                <img src="<?= base_url() ?>assets/web/assets/img/room_lg_1.jpg" alt="Thumb">
              </div>
              <div class="cs_gallery_slider_thumb_item">
                <img src="<?= base_url() ?>assets/web/assets/img/room_lg_2.jpg" alt="Thumb">
              </div>
              <div class="cs_gallery_slider_thumb_item">
                <img src="<?= base_url() ?>assets/web/assets/img/room_lg_3.jpg" alt="Thumb">
              </div>
              <div class="cs_gallery_slider_thumb_item">
                <img src="<?= base_url() ?>assets/web/assets/img/room_lg_1.jpg" alt="Thumb">
              </div>
            ...
            <div class="cs_slider_wrapper">
              ...
              <div class="cs_slide">
                <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                  ...
                  <div class="cs_card_info position-relative">
                    <h2 class="cs_card_title cs_fs_50 cs_mb_4"><a href="<?= base_url() ?>in/room_detail">Superior Room</a></h2>
                    <div class="cs_card_price cs_mb_17">
                      <span class="cs_primary_color">From</span>
              ...
              <div class="cs_slide">
                <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                  <a href="<?= base_url() ?>in/room_detail" class="cs_card_thumb d-block overflow-hidden position-relative cs_primary_bg">
                    <img src="<?= base_url() ?>assets/web/assets/img/room_22.jpg" alt="Room">
                    <span class="cs_card_btn position-absolute cs_zindex_2">
                      <span class="cs_btn cs_style_2 cs_accent_btn cs_medium cs_radius_5 cs_fs_15">
                        <b>Details View</b>
                        <span>
                  ...
                  <div class="cs_card_info position-relative">
                    <h2 class="cs_card_title cs_fs_50 cs_mb_4"><a href="<?= base_url() ?>in/room_detail">Pearl Suite</a></h2>
                    <div class="cs_card_price cs_mb_17">
                      <span class="cs_primary_color">From</span>
                      <span class="cs_accent_color cs_fs_38 cs_primary_font">$320/Night</span>
                    </div>
              ...
              <div class="cs_slide">
                <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                  <a href="<?= base_url() ?>in/room_detail" class="cs_card_thumb d-block overflow-hidden position-relative cs_primary_bg">
                    <img src="<?= base_url() ?>assets/web/assets/img/room_23.jpg" alt="Room">
                    <span class="cs_card_btn position-absolute cs_zindex_2">
                      <span class="cs_btn cs_style_2 cs_accent_btn cs_medium cs_radius_5 cs_fs_15">
                        <b>Details View</b>
                        <span>
                  ...
                  <div class="cs_card_info position-relative">
                    <h2 class="cs_card_title cs_fs_50 cs_mb_4"><a href="<?= base_url() ?>in/room_detail">Sunrise Villa</a></h2>
                    <div class="cs_card_price cs_mb_17">
                      <span class="cs_primary_color">From</span>
                      <span class="cs_accent_color cs_fs_38 cs_primary_font">$450/Night</span>
                    </div>
              ...
              <div class="cs_slide">
                <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                  <a href="<?= base_url() ?>in/room_detail" class="cs_card_thumb d-block overflow-hidden position-relative cs_primary_bg">
                    <img src="<?= base_url() ?>assets/web/assets/img/room_24.jpg" alt="Room">
                    <span class="cs_card_btn position-absolute cs_zindex_2">
                      <span class="cs_btn cs_style_2 cs_accent_btn cs_medium cs_radius_5 cs_fs_15">
                        <b>Details View</b>
                        <span>
                  ...
                  <div class="cs_card_info position-relative">
                    <h2 class="cs_card_title cs_fs_50 cs_mb_4"><a href="<?= base_url() ?>in/room_detail">Sea View</a></h2>
                    <div class="cs_card_price cs_mb_17">
                      <span class="cs_primary_color">From</span>
                      <span class="cs_accent_color cs_fs_38 cs_primary_font">$520/Night</span>
                    </div>
